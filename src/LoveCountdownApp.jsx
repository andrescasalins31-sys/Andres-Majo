...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-pink-50 via-purple-50 to-white p-6 overflow-hidden font-[Dancing Script]">
      {/* Carrusel de fondo */}
      <BackgroundCarousel />

      {/* Música de fondo */}
      <audio id="music" src="/cepeda.mp3" loop />

      <div className="z-10 max-w-3xl w-full rounded-2xl shadow-2xl p-6 md:p-12 bg-white/80 backdrop-blur-md text-center relative">
        {!showCountdown ? (
          <motion.div
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-pink-600 mb-3">
              Eres el amor de mi vida
            </h1>
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed">
              y de todas mis vidas,{" "}
              <span className="text-purple-600">te amo</span> y{" "}
              <span className="text-pink-500">te amaré</span> hasta el infinito 💞
            </p>
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-purple-600">
                Tiempo restante para nuestro concierto juntitos de Cepeda 💖
                <br />
                <span className="text-pink-500">
                  Andres Casalins & Majo Aguilar
                </span>
              </h2>
            ...
            <p className="mt-6 text-xl text-gray-700">
              Que todos nuestros sueños se cumplan y seamos felices,{" "}
            ...
            <div className="mt-10">
              <p className="text-lg mb-2 text-gray-700">
                💚 Escucha nuestra playlist del álbum{" "}
                <strong>“Bogotá”</strong> de Andrés Cepeda:
              </p>
              <a
                href="https://open.spotify.com/intl-es/album/4c6ohu9SHcvy5FUrPu3Q60?si=a5fcff4a5509429b"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-green-500 hover:bg-green-400 text-white px-6 py-2 rounded-full font-semibold shadow-md transition"
              >
                🎧 Escuchar en Spotify
              </a>
              <div className="mt-4">
                <img
                  src="/images/spotifyQR.jpeg"
                  alt="QR Spotify Bogotá"
...
function TimeCard({ label, value }) {
  return (
    <div className="flex flex-col items-center justify-center bg-white/70 backdrop-blur-sm rounded-2xl p-4 shadow-md">
      <div className="text-4xl font-extrabold text-pink-500 tabular-nums">
