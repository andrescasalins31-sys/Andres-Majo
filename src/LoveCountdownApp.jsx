...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-pink-50 via-purple-50 to-white p-6 relative overflow-hidden font-[Dancing Script]">
      
      {/* Música de fondo */}
      <audio id="music" src="/cepeda.mp3" loop />

      <div className="max-w-3xl w-full rounded-2xl shadow-2xl p-6 md:p-12 bg-white/80 backdrop-blur-sm text-center">
        {!showCountdown ? (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <motion.button
              ...
              onClick={() => {
                ...
                document.getElementById('music').play(); // activar música
              }}
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
            ...
            <p className="mt-6 text-xl text-gray-700">
              Que todos nuestros sueños se cumplan y seamos felices, <span className="text-pink-500 font-semibold">Te amo mi niña 💕</span>
            </p>
          </motion.div>
        )}
      </div>
